...
`print`でたくさん標準出力を使っていますが、
そこの値は重要ではないので
私は[quickrun](https://github.com/thinca/vim-quickrun)を使って
...
おそらく、if文が実行される回数が少ないはず、なのでpythonのデバッガである[pdb](https://docs.python.org/3/library/pdb.html)を使って調べてみます。
